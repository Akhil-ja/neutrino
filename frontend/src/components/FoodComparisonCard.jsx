...
function FoodComparisonCard({ food, compareFood }) {
  const getComparisonColor = (value, compareValue) => {
    if (!compareFood || value === undefined || compareValue === undefined)
      return "inherit";
  ...
  const createChartData = (nutrientKey) => {
    ...
    if (compareFood && compareFood[nutrientKey] !== undefined) {
      data.push({
        name: compareFood.food_name,
        value: compareFood[nutrientKey],
      });
    }
    return data;
  };
    ...
    <Card sx={{ height: "100%", display: "flex", flexDirection: "column" }}>
      <CardContent sx={{ flexGrow: 1 }}>
        ...
        <Typography
          variant="body1"
          sx={{
            color: getComparisonColor(food.nf_protein, compareFood?.nf_protein),
          }}
        >
        ...
        <Typography
          ...
          sx={{
            color: getComparisonColor(
              ...
              compareFood?.nf_total_carbohydrate
            ),
          }}
        >
          Carbs:{" "}
